...
%path1 = '/data/kuw/biocore/wlku/Keji/run865_KZ1011/';
%path2 = '/data/kuw/biocore/wlku/Keji/';
%path3 = '/data/kuw/biocore/wlku/Keji/run865_KZ1011/';
...
fp = fopen(strcat(char(path2), 'quantify_cpp'), 'w');

fprintf(fp,'%s\n', 'make -f make_quantify_cpp');
fprintf(fp,'\n');
for i = 1:msize
    fprintf(fp, '%s  ', './haha');
    ...
    fprintf(fp, '%s  ', strcat(char(c(1)), char(fileend2)));
    fprintf(fp,'\n');
    fprintf(fp,'\n');
end;
fclose(fp);
